...
public class HomeController {
	...
	public String setDefaultPayment(@ModelAttribute("defaultUserPaymentId") Long userPaymentId, Principal principal,
			Model model) {
		User user = userService.findByUsername(principal.getName());
	...
	public String setDefaultUserShipping(@ModelAttribute("defaultShippingAddressId") Long userShippingId,
